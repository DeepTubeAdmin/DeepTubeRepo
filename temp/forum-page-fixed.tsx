...
export default function ForumPage() {
  ...
  const createCommentMutation = useMutation({
    mutationFn: async (data: any) => {
      console.log(
        ...
        `/api/forum/threads/${activeThread}/comments`
      );
  ...
  const filteredThreads = sortedThreads.filter((thread) => {
    ...
    const matchesCategory = activeCategory
      ? thread.categoryId === activeCategory
      : true;
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            ...
            {isAdmin && (
              <Button
                variant="outline"
                onClick={() => setIsStickyThreadDialogOpen(true)}
              >
            ...
            >
              <DialogContent className="sm:max-w-2xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Share your thoughts with the community. Be respectful and
              ...
              >
                <DialogContent className="sm:max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Create an important announcement that will stay at the top
                      of the forum.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
