    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[800px] max-h-[80vh] overflow-y-auto bg-[#121212] text-white border border-gray-700">
        ...
        <div className="space-y-6 py-4 text-sm text-gray-300">
          ...
          <div className="faq-section">
            <h3 className="text-lg font-semibold text-orange-500 mb-2">4. Content Upload and Ownership</h3>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div className="faq-section">
            <h3 className="text-lg font-semibold text-orange-500 mb-2">5. Content Guidelines and Strict Legal Compliance</h3>
            <p>
            ...
            <p className="mt-2">We reserve the right to remove, disable, or restrict any User Content that violates these Terms or applicable laws, without notice.</p>
          </div>
          
          <div className="faq-section">
            <h3 className="text-lg font-semibold text-orange-500 mb-2">6. Intellectual Property</h3>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div className="faq-section">
            <h3 className="text-lg font-semibold text-orange-500 mb-2">7. Monetization and Payments</h3>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div className="faq-section">
            <h3 className="text-lg font-semibold text-orange-500 mb-2">8. User Conduct</h3>
          ...
          <div className="faq-section">
            <h3 className="text-lg font-semibold text-orange-500 mb-2">9. Privacy</h3>
            <p>
          ...
          <div className="faq-section">
            <h3 className="text-lg font-semibold text-orange-500 mb-2">11. Disclaimers and Limitation of Liability</h3>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div className="faq-section">
            <h3 className="text-lg font-semibold text-orange-500 mb-2">12. Indemnification</h3>
            <p>
          ...
          <div className="faq-section">
            <h3 className="text-lg font-semibold text-orange-500 mb-2">13. Governing Law and Dispute Resolution</h3>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div className="faq-section">
            <h3 className="text-lg font-semibold text-orange-500 mb-2">15. Contact Us</h3>
            <p>
