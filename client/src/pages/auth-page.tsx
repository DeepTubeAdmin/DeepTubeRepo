  ...
  const handleSocialLogin = (provider: string) => {
    ...
    if (!available.includes(provider)) {
      toast({
        ...
        description: `We're working to support ${provider} login soon.`,
        variant: "default",
      });
      return;
    }
        ...
        <div className="w-full md:w-1/2 bg-gradient-to-br from-primary/90 to-primary-foreground/90 p-8 flex flex-col justify-center text-white">
          <div className="max-w-lg mx-auto space-y-8">
            ...
            <p className="text-lg mb-6">
              Discover and share high-quality AI-generated media from creators
              around the world. Upload your own AI-generated content and join
              our community.
            </p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white/80">
                    Share your AI generation skills
                  </p>
                </div>
              </div>
